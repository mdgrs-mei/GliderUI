...
internal class MethodDef
{
    ...
    public string GetSignatureExpression()
    {
        ...
        string newExpression = (_apiMethodDef.HidesBase && ExplicitInterfaceType is null) ? "new " : "";
    ...
    {
        return ParameterDef.GetParametersSignatureExpression(Parameters, genericTypeParametersOverride, _apiMethodDef.IsExtension);
    }
